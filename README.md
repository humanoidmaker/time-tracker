...
git clone https://github.com/humanoidmaker/time-tracker.git
cd time-tracker
...
# Check status
kubectl get pods -n time-tracker

# View logs
kubectl logs -f deployment/backend -n time-tracker

# Scale
kubectl scale deployment/backend --replicas=3 -n time-tracker
```
